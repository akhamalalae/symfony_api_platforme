 ...
 */
final class Version20230408181329 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE user ADD CONSTRAINT FK_8D93D6496C8A81A9 FOREIGN KEY (products_id) REFERENCES products (id)');
