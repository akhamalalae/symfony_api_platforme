 ...
 */
final class Version20230408173908 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE products ADD CONSTRAINT FK_B3BA5A5A462F07AF FOREIGN KEY (product_order_id) REFERENCES orders (id)');
