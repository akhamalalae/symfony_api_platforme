 ...
 */
final class Version20230408181959 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE orders ADD product_id INT DEFAULT NULL, ADD libelle VARCHAR(255) DEFAULT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE orders DROP product_id, DROP libelle');
    }
}
